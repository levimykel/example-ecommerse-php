...
This is a sample PHP eCommerce website with content managed with prismic.io (API-based CMS).

#### Getting started

Read [this guide](https://prismic.io/docs/examples/ecommerce#?lang=php) for instructions to create your repository and use this sample eCommerce site.
