 ...
 * Snipcart Key
 */
define('SNIPCART_KEY', null);

/*
 * Your site metadata
 */
define('SITE_TITLE', 'prismic.io Sample eCommerce Site in PHP');
define('SITE_DESCRIPTION', 'This is the PHP sample eCommerce project for prismic.io');
